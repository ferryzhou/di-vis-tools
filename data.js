var panel_contents = {
  ...
  "Data Integration / ETL": {
	...
	"Commercial GUI Tools": ["Microsoft", "Infomatica", "IBM", "SAP", "CloverETL", 
	      "SAS Data Management", "Oracle", "Talend", "Information Builders"],
	"Programming/API": ["SAS Scripts", "JAVA/JDBC", "Python", "Spring Data"]
  },
  "Good Data": {
    "Text Files":   ["CSV", "XML", "JSON"],
	"Database":     ["RDBMS", "NoSQL", "Big Data"],
  ...
  "Data Presentation / BI": {
    "Free GUI Tools": ["Tableau Public", "Pentaho BI CE", "QlikView", "Microstrategy Analytics"],
	"Commercial GUI Tools": ["Microstrategy", "Tableau", "Pentaho EE", "Tibco Spotfire",
	    "Oracle", "SAP", "QlikTech", "Information Builders", "Birst", "Panorama", "Actuate",
		"Jaspersoft", "Alteryx", "GoodData", "Prognoz", "Bitam", "Targit"],
